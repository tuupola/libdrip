 ...
 *
 * DRIP_EDDSA_CURVE_ED25519 is recommended and currently hardcoded
 * in the code.
 *
...
typedef enum {
    ...
    DRIP_EDDSA_CURVE_ED25519 = 1,
    DRIP_EDDSA_CURVE_ED25519PH = 2,
    DRIP_EDDSA_CURVE_ED448 = 3,
    DRIP_EDDSA_CURVE_ED448PH = 4,
} drip_eddsa_curve_t;
